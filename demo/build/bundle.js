...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = Redux.createStore(reducer_1.reducer);
	var client = new client_1.StateClient(function () { }, function (actions) {
	    store.dispatch({ type: 'ACTIONS', actions: actions });
	});
	document.addEventListener('keydown', function (e) {
	    console.log(e.keyCode);
	    if (e.keyCode === 37)
	        client.sendInput('left', true);
	    if (e.keyCode === 39)
	        client.sendInput('right', true);
	});
	document.addEventListener('keyup', function (e) {
	    console.log(e.keyCode);
	    if (e.keyCode === 37)
	        client.sendInput('left', false);
	    if (e.keyCode === 39)
	        client.sendInput('right', false);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer(state, action) {
	    ...
	    if (action.type !== 'ACTIONS')
	        action = { type: 'ACTIONS', actions: [action] };
	    var players;
	    return action.actions.reduce(function (state, action) {
	        switch (action.type) {
	            ...
	            case 'MOVE_LEFT':
	                return state.updateIn(['players', action.playerId, 'x'], function (x) { return x - 5; });
	            case 'MOVE_RIGHT':
	                return state.updateIn(['players', action.playerId, 'x'], function (x) { return x + 5; });
	            default:
	                return state;
